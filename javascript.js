...
let ping1=new Audio('ping1.wav');
  ping1.volume=1;

let bgm=new Audio('bgm.mp3');
  bgm.volume=0.1;
  bgm.addEventListener('ended', function() {  //loop
    this.currentTime = 0;
    this.play();
},
false);

let du_vant=new Audio('vinn.wav');
  du_vant.volume=1;
...
var Game = {
  ...
  menu: function () {
      ...
      // Change the canvas font size and color
      this.context.font = '50px Arial, Helvetica, sans-serif';
  ...
  update: function () {
      ...
      if (this.player.score === rounds[this.round]) {
          ...
          if (!rounds[this.round + 1]) {
              this.over = true;
              setTimeout(function () { Pong.endGameMenu('Seier!'); }, 1000);
              du_vant.play();
          } else {
  ...
  draw: function () {
      ...
      this.context.font = '100px Arial, Helvetica, sans-serif';
      ...
      this.context.font = '30px Arial, Helvetica, sans-serif';
      ...
      this.context.font = '40px Arial, Helvetica, sans-serif';
